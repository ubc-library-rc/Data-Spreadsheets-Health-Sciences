...
**Example**: using -4 or other numerical values (or zero) to represent missing data. 
...
Whatever the reason, it's a problem if unknown or missing data is recorded as -4, -999, 999, or 0.
...
**Example**: Your data was collected, in part, by a temporary employee who you later found out was recording the site code differently some
...
**Example**: You record age and gender data for each patient. You enter this as 74 Male, 78 Female, etc.
...
If you need both these measurements, design your data sheet to include this information. For example, include one column for age and a separate column for gender.
...
collecting and analysing it, but the chances that you will still remember that the variable "PTID" means patient ID, for
